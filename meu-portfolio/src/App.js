      ...
      <nav className="navbar">
        ...
        <ul className="nav-links">
          ...
          <li className="icon-link">
            <a href="/jogo-forca">
              <img
                src="/imagens/pedestrian-man.png"
                alt="Ir para jogo da forca"
                className="nav-icon"
              />
            </a>
          </li>
          ...
          <div className="cards-container" id="cards">
            ...
            <div className="card">
              ...
              <p>
                ...
                front-end de forma introdutória.
              </p>
            ...
            <div className="card">
              ...
              <h3>Palestra Front-end Recife</h3>
              ...
              <p>
                Palestra introdutória sobre desenvolvimento front-end.
              </p>
        ...
        <div className="cards-container">
          ...
          <div className="card-andamento">
            ...
            <p>
              ...
              Game para auxiliar crianças com dislexia.
            </p>
